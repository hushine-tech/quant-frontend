...
assert.match(chartPanelSource, /fill\.qty_decimal/, "Session fill markers must render exact quantity text");
assert.match(chartPanelSource, /fill\.fill_price_decimal/, "Session fill markers must render exact price text");
assert.doesNotMatch(chartPanelSource, /fill\.qty(?!_decimal)/, "Session fill markers must not read removed float quantity");
assert.doesNotMatch(chartPanelSource, /fill\.fill_price(?!_decimal)/, "Session fill markers must not read removed float price");
